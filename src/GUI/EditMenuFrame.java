...
public class EditMenuFrame {
    ...
    public EditMenuFrame(AdminClass Admin) {
        ...
        ImageIcon imageIcon = new ImageIcon(getClass().getResource("/Images/Backgrounds/OriRestaurant Logo.png"));
        ...
        //--------------//
        MainBackground = new PanelBackground(getClass().getResource("/Images/Backgrounds/Edit Menu Background.jpg"));
